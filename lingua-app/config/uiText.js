const UI_TEXT={
  ...
  zh:{
    ...
    scan:{eyebrow:"快速扫读", title:"点出你不认识的词", teacher:"先通读一遍，把不确定的词点一下 —— 我会针对这些词来准备词汇讲解。不确定也没关系，可以跳过。", hint:"点词标记 · 再点取消。", marked:(n)=>`已标记 ${n} 个词`, none:"还没有标记 —— 点出不认识的词，或直接跳过。", skip:"跳过 — 自动帮我选词", done:"就这些 →"},
