const UI_TEXT={
  en:{
    ...
    saveProgress:{title:"Save this lesson", body:(n)=>`Keep today's progress and ${n} word${n===1?"":"s"} for later review.`, saveWithLogin:"Log in to save", save:"Save progress", saving:"Saving...", savedTitle:"Lesson saved", savedBody:"Your progress and wordlist are in your account.", savedButton:"Saved", savedDetail:(n)=>`Saved this lesson and ${n} word${n===1?"":"s"}.`, sendLink:"Send sign-in link", sending:"Sending...", linkSent:"Check your email, then come back here and I'll save this lesson automatically.", noPassword:"No password needed. You only log in when you want to keep your learning.", error:"Could not save just now.", notConfigured:"Saving is not configured yet. Add Supabase auth keys and database tables first."},
    ia:{learn:"Learn",progress:"Progress",collection:"Collection"},
    account:{signInToSave:"Sign in to save", signedIn:"Signed in", signOut:"Sign out"},
    ...
    progress:{title:"Progress", subtitle:"Your lesson history and current course progress live here.", signInTitle:"Sign in to keep your progress", signInBody:"You can explore freely without an account. Sign in when you want lessons and progress to stay available later.", emptyTitle:"No progress yet", emptyBody:"Finish and save a lesson, and it will appear here.", startLearning:"Start learning", loading:"Loading progress...", loadError:"Could not load progress.", continueLearning:"Continue learning", currentLesson:"Current lesson", resume:"Resume", recentLessons:"Recent lessons", untitledLesson:"Untitled lesson", lessonsCompleted:"Lessons completed", sentences:(n)=>`${n} sentences`, words:(n)=>`${n} words`, steps:(n)=>`${n} steps`},
  ...
  zh:{
    ...
    saveProgress:{title:"保存这节课", body:(n)=>`保存今天的学习进度和 ${n} 个词，之后可以回来复习。`, saveWithLogin:"登录并保存", save:"保存进度", saving:"保存中...", savedTitle:"已保存", savedBody:"这节课的进度和词表已经存到你的账户。", savedButton:"已保存", savedDetail:(n)=>`已保存这节课和 ${n} 个词。`, sendLink:"发送登录链接", sending:"发送中...", linkSent:"请查看邮箱。登录回来后，我会自动保存这节课。", noPassword:"不需要密码。只有当你想保存学习记录时才需要登录。", error:"暂时无法保存。", notConfigured:"保存功能还没有配置。请先添加 Supabase 登录密钥和数据库表。"},
    ia:{learn:"学习",progress:"进度",collection:"收藏"},
    account:{signInToSave:"登录后保存", signedIn:"已登录", signOut:"退出登录"},
    authPrompt:{title:"登录后保存", body:"登录后可以保留你的词汇、语法和学习记录。你也可以继续学习，但这条内容不会被保存。", signIn:"登录", keepLearning:"继续学习", close:"关闭"},
    progress:{title:"学习进度", subtitle:"课程历史和当前学习进度会出现在这里。", signInTitle:"登录后保留学习进度", signInBody:"不登录也可以自由探索。等你想把课程和进度留到之后再看时，可以登录。", emptyTitle:"还没有学习记录", emptyBody:"完成并保存一节课后，它会出现在这里。", startLearning:"开始学习", loading:"正在加载进度...", loadError:"暂时无法加载进度。", continueLearning:"继续学习", currentLesson:"当前课程", resume:"继续", recentLessons:"最近课程", untitledLesson:"未命名课程", lessonsCompleted:"完成课程", sentences:(n)=>`${n} 个句子`, words:(n)=>`${n} 个词`, steps:(n)=>`${n} 步`},
