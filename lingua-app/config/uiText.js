const UI_TEXT={
  en:{
    ...
    survey:{title:"Quick feedback", most:"Which step helped most?", least:"Which step helped least?", submit:"Submit", skip:"Skip", close:"Close", thanks:"Thanks — that helps us shape the lessons."},
    donation:{title:"Support Lingua's development", body:"Help keep improving the app for language learners.", button:"Support with €1.99", soon:"Stripe checkout coming soon."},
  ...
  zh:{
    ...
    survey:{title:"快速反馈", most:"哪个步骤帮助最大？", least:"哪个步骤帮助最小？", submit:"提交", skip:"跳过", close:"关闭", thanks:"谢谢 —— 这会帮我们把课程做得更好。"},
    donation:{title:"支持 Lingua 继续改进", body:"帮助开发者继续为语言学习者改进这个应用。", button:"Support with €1.99", soon:"Stripe 支付即将接入。"},
