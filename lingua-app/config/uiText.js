const UI_TEXT={
  en:{
    ...
    progress:{title:"Progress", subtitle:"Your completed lessons and saved learning history live here.", signInTitle:"Sign in to keep your progress", signInBody:"You can explore freely without an account. Sign in when you want lessons and progress to stay available later.", emptyTitle:"No progress yet", emptyBody:"Finish and save a lesson, and it will appear here.", startLearning:"Start learning", loading:"Loading progress...", loadError:"Could not load progress.", continueLearning:"Continue learning", currentLesson:"Current lesson", resume:"Resume", recentLessons:"Recent lessons", untitledLesson:"Untitled lesson", lessonsCompleted:"Lessons completed", wordsCollected:"Words collected", grammarCollected:"Grammar saved", sentences:(n)=>`${n} sentences`, words:(n)=>`${n} words`, steps:(n)=>`${n} steps`},
    ...
    loginTitle:"Learn any language through content you love", loginSub:"Paste a text, transcript, or article excerpt, and it becomes a complete guided learning session.", loginLinkSent:"Check your email for the sign-in link.", loginError:"Could not send the sign-in link.",
  ...
  zh:{
    ...
    progress:{title:"学习进度", subtitle:"你完成并保存过的课程会出现在这里。", signInTitle:"登录后保留学习进度", signInBody:"不登录也可以自由探索。等你想把课程和进度留到之后再看时，可以登录。", emptyTitle:"还没有学习记录", emptyBody:"完成并保存一节课后，它会出现在这里。", startLearning:"开始学习", loading:"正在加载进度...", loadError:"暂时无法加载进度。", continueLearning:"继续学习", currentLesson:"当前课程", resume:"继续", recentLessons:"最近课程", untitledLesson:"未命名课程", lessonsCompleted:"完成课程", wordsCollected:"收藏词汇", grammarCollected:"收藏语法", sentences:(n)=>`${n} 个句子`, words:(n)=>`${n} 个词`, steps:(n)=>`${n} 步`},
    collection:{title:"收藏", subtitle:"从课程中保存的词汇和语法会放在这里。", signInTitle:"登录后保存收藏", signInBody:"不登录也可以继续学习，但词汇和语法只有登录后才能保存。", wordsTab:"词表", grammarTab:"语法", save:"收藏", saving:"保存中...", saved:"已收藏", loading:"正在加载收藏...", loadError:"暂时无法加载收藏。", language:"语言", level:"等级", source:"来源", emptyWords:{title:"还没有收藏词汇", body:"在课程词卡里点收藏后，它们会出现在这里。"}, emptyGrammar:{title:"还没有收藏语法", body:"在课程语法卡里点收藏后，可以在这里复习。"}},
    ...
    loginTitle:"用你喜欢的内容学习任何语言", loginSub:"粘贴一段文本、字幕或文章节选，它会变成一节完整的引导式学习课。", loginLinkSent:"请查看邮箱里的登录链接。", loginError:"暂时无法发送登录链接。",
