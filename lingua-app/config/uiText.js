const UI_TEXT={
  ...
  zh:{
    ...
    collection:{title:"收藏", subtitle:"从课程中保存的词汇和语法会放在这里。", signInTitle:"登录后保存收藏", signInBody:"不登录也可以继续学习，但词汇和语法只有登录后才能保存。", wordsTab:"词表", grammarTab:"语法", save:"收藏", saving:"保存中...", saved:"已收藏", saveError:"重试", loading:"正在加载收藏...", loadError:"暂时无法加载收藏。", language:"语言", level:"等级", source:"来源", emptyWords:{title:"还没有收藏词汇", body:"在课程词卡里点收藏后，它们会出现在这里。"}, emptyGrammar:{title:"还没有收藏语法", body:"在课程语法卡里点收藏后，可以在这里复习。"}},
