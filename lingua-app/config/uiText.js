const UI_TEXT={
  en:{
    ...
    saveProgress:{title:"Save this lesson to Progress", body:(n)=>`Keep this lesson, your marked words, and your practice work for later review.`, includePractice:"Include my recall answers and AI practice", disappears:"If you do not save, this lesson stays only on this device and may disappear when you start a new lesson or clear local data.", saveWithLogin:"Log in to save", save:"Save lesson", saving:"Saving...", savedTitle:"Lesson saved", savedBody:"This lesson is now in Progress. Words only go to Collection when you save them there.", savedButton:"Saved", savedDetail:(n)=>`Saved this lesson with ${n} study word${n===1?"":"s"}.`, sendLink:"Send sign-in link", sending:"Sending...", linkSent:"Check your email, then come back here and I'll save this lesson automatically.", noPassword:"No password needed. You only log in when you want to keep your learning.", error:"Could not save just now.", notConfigured:"Saving is not configured yet. Add Supabase auth keys and database tables first."},
    ia:{learn:"Learn",progress:"Progress",collection:"Collection"},
    account:{signInToSave:"Sign in to save", signedIn:"Signed in", signedInAs:(email)=>`Signed in as ${email}`, signOut:"Sign out"},
    authPrompt:{title:"Sign in to save this", body:"Keep your words, grammar, and lesson history in your account. You can keep learning without signing in, but this item will not be saved.", signIn:"Sign in", keepLearning:"Keep learning", close:"Close"},
    progress:{title:"Progress", subtitle:"Your saved lessons and current lesson live here.", signInTitle:"Sign in to keep your progress", signInBody:"You can explore freely without an account. Sign in when you want lessons and progress to stay available later.", emptyTitle:"No saved lessons yet", emptyBody:"Finish and save a lesson, and it will appear here.", startLearning:"Start learning", loading:"Loading progress...", loadError:"Could not load progress.", continueLearning:"Continue current lesson", currentLesson:"Current lesson", resume:"Resume", savedLessons:"Saved lessons", savedText:"Source text", markedWords:"Marked words", recallAnswers:"Recall answers", aiWriting:"AI writing practice", aiConversation:"AI conversation", recentLessons:"Recent lessons", untitledLesson:"Untitled lesson", lessonsCompleted:"Completed lessons", sentences:(n)=>`${n} sentences`, words:(n)=>`${n} words`, steps:(n)=>`${n} steps`},
    collection:{title:"Collection", subtitle:"Saved words and grammar from your lessons.", signInTitle:"Sign in to save your collection", signInBody:"You can keep learning without an account, but words and grammar are only saved after you sign in.", wordsTab:"Word List", grammarTab:"Grammar", save:"Save", saving:"Saving...", saved:"Saved", removing:"Removing...", removeHint:"Click to remove", saveError:"Try again", loading:"Loading collection...", loadError:"Could not load collection.", language:"Language", level:"Level", source:"Source", emptyWords:{title:"No words saved yet", body:"Save words from lesson cards and they will appear here."}, emptyGrammar:{title:"No grammar saved yet", body:"Save grammar patterns from lessons and review them here."}},
    ...
    loginTitle:"Learn any language through content you love", loginSub:"Paste a text, transcript, or article excerpt, and it becomes a complete guided learning session.", loginChecking:"Checking sign-in...", loginLinkSent:"Check your email for the sign-in link.", loginError:"Could not send the sign-in link.",
    ...
    previewTitle:"Here's your text", previewSub:"A quick read on your material before we begin.", topics:"Topics:", previewTextTitle:"Full text", previewTextHint:"Preview the first lines, or expand it if you want the whole text.", previewTextExpand:"Expand full text", previewTextCollapse:"Collapse text",
    ...
    session:"The session", stepsInBlocks:(s,b)=>`${s} steps in ${b} blocks`, start:(m)=>`Start · ~${m} min`, startLearning:"Start learning",
    ...
    nav:{
      ...
      ctx:"Your learning path", ctxSession:(lang,level)=>`${lang} · ${level}`, backHome:"Back to home page", previewHint:"Preview of your path", lockedHint:"Add a text first — import your own or generate one with AI — and these steps open up.", lockedLine:"🔒 These steps unlock once you have a text.", quickScan:"Quick Scan",
    },
    diagnosis:{
  ...
  zh:{
    ...
    saveProgress:{title:"保存这节课到进度", body:(n)=>`保存这节课、你标记的词和练习内容，之后可以回来复习。`, includePractice:"包含我的回忆答案和 AI 练习", disappears:"如果不保存，这节课只会留在当前设备上；开始新课程或清除本地数据后可能消失。", saveWithLogin:"登录并保存", save:"保存课程", saving:"保存中...", savedTitle:"已保存", savedBody:"这节课已经保存到进度。词汇只有在你主动收藏时才会进入收藏。", savedButton:"已保存", savedDetail:(n)=>`已保存这节课和 ${n} 个学习词。`, sendLink:"发送登录链接", sending:"发送中...", linkSent:"请查看邮箱。登录回来后，我会自动保存这节课。", noPassword:"不需要密码。只有当你想保存学习记录时才需要登录。", error:"暂时无法保存。", notConfigured:"保存功能还没有配置。请先添加 Supabase 登录密钥和数据库表。"},
    ia:{learn:"学习",progress:"进度",collection:"收藏"},
    account:{signInToSave:"登录后保存", signedIn:"已登录", signedInAs:(email)=>`已登录：${email}`, signOut:"退出登录"},
    authPrompt:{title:"登录后保存", body:"登录后可以保留你的词汇、语法和学习记录。你也可以继续学习，但这条内容不会被保存。", signIn:"登录", keepLearning:"继续学习", close:"关闭"},
    progress:{title:"学习进度", subtitle:"保存过的课程和当前课程会出现在这里。", signInTitle:"登录后保留学习进度", signInBody:"不登录也可以自由探索。等你想把课程和进度留到之后再看时，可以登录。", emptyTitle:"还没有保存课程", emptyBody:"完成并保存一节课后，它会出现在这里。", startLearning:"开始学习", loading:"正在加载进度...", loadError:"暂时无法加载进度。", continueLearning:"继续当前课程", currentLesson:"当前课程", resume:"继续", savedLessons:"已保存课程", savedText:"原文", markedWords:"标记词", recallAnswers:"回忆答案", aiWriting:"AI 写作练习", aiConversation:"AI 对话", recentLessons:"最近课程", untitledLesson:"未命名课程", lessonsCompleted:"完成课程", sentences:(n)=>`${n} 个句子`, words:(n)=>`${n} 个词`, steps:(n)=>`${n} 步`},
    collection:{title:"收藏", subtitle:"从课程中保存的词汇和语法会放在这里。", signInTitle:"登录后保存收藏", signInBody:"不登录也可以继续学习，但词汇和语法只有登录后才能保存。", wordsTab:"词表", grammarTab:"语法", save:"收藏", saving:"保存中...", saved:"已收藏", removing:"移除中...", removeHint:"点击移出收藏", saveError:"重试", loading:"正在加载收藏...", loadError:"暂时无法加载收藏。", language:"语言", level:"等级", source:"来源", emptyWords:{title:"还没有收藏词汇", body:"在课程词卡里点收藏后，它们会出现在这里。"}, emptyGrammar:{title:"还没有收藏语法", body:"在课程语法卡里点收藏后，可以在这里复习。"}},
    ...
    loginTitle:"用你喜欢的内容学习任何语言", loginSub:"粘贴一段文本、字幕或文章节选，它会变成一节完整的引导式学习课。", loginChecking:"正在检查登录状态...", loginLinkSent:"请查看邮箱里的登录链接。", loginError:"暂时无法发送登录链接。",
    ...
    previewTitle:"这是你的文本概览", previewSub:"开始前先快速了解这份材料。", topics:"主题：", previewTextTitle:"完整文本", previewTextHint:"先预览前几行；想读完整内容可以展开。", previewTextExpand:"展开全文", previewTextCollapse:"收起全文",
    ...
    session:"学习流程", stepsInBlocks:(s,b)=>`${s} 个步骤，分成 ${b} 个模块`, start:(m)=>`开始 · 约 ${m} 分钟`, startLearning:"开始学习",
    ...
    done:{friend:"同学",title:()=>`你完成了！`,sub:(n)=>`你完整走完了 ${n} 个学习步骤。真正难的是开始并坚持到最后，而你已经做到了。`,explored:(topics)=>`今天你学习了 ${topics}`,more:"多带几段文本来，我们会慢慢看出你喜欢哪些主题、常在哪些地方投入时间。",steps:"步骤",words:"词汇",sentences:"句子",blocks:"模块",comp:"理解度 · 前后对比",rate:"最后再问一次：现在你大概能理解多少？",reveal:"查看我的进步",before:"之前",after:"之后",gain:(d)=>`理解度 +${d}% ，很漂亮`,again:"再来一遍会继续提升，你已经在路上了",take:"你带走的内容",review:"复习这节课",new:"导入新材料"},
    ...
    nav:{
      ...
      ctx:"你的学习路径", ctxSession:(lang,level)=>`${lang} · ${level}`, backHome:"返回首页", previewHint:"路径预览", lockedHint:"先准备一段文本——可以自己导入，也可以用 AI 生成——这些步骤就会解锁。", lockedLine:"🔒 有了文本之后，这些步骤会自动解锁。", quickScan:"快速扫读",
    },
    diagnosis:{
