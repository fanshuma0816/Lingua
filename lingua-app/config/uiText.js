const UI_TEXT={
  en:{
    ...
    fullSourceAudio:"Full source audio", fullSourceRead:"Full-source read-aloud", audioUnsupported:"Audio not supported in this browser", audioLoading:"Preparing audio…", audioReady:"Ready — tap play", audioUnavailable:"Audio unavailable",
    ...
    nav:{
      ...
      steps:{d1:"Reading check",d2:"Blind listening",d3:"Diagnosis",l1:"Understand in English",l2:"Under the microscope",s1:"Shadow · with subtitles",s2:"Shadow · no subtitles",r1:"Recall from English",u1:"Practice with AI"},
  ...
  zh:{
    ...
    fullSourceAudio:"完整原文音频", fullSourceRead:"完整朗读", audioUnsupported:"当前浏览器不支持音频", audioLoading:"正在准备音频…", audioReady:"准备好了，点击播放", audioUnavailable:"音频暂时不可用",
    ...
    nav:{
      ...
      steps:{d1:"阅读检测",d2:"盲听",d3:"诊断",l1:"用英文理解",l2:"逐句拆解",s1:"带字幕跟读",s2:"无字幕跟读",r1:"英文提示回忆",u1:"和 AI 练习"},
