const UI_TEXT={
  en:{
    ...
    donation:{title:"Support Lingua's development ✨", body:"A small boost helps Lingua grow for more language learners 🌱", button:"Support with €1.99", soon:"Secure checkout powered by Stripe.", feedbackLabel:"Share an idea if you want", feedbackPlaceholder:"Anything you'd like us to improve?"},
  ...
  zh:{
    ...
    donation:{title:"支持 Lingua 继续改进 ✨", body:"一点小小支持，会帮助 Lingua 陪更多语言学习者成长 🌱", button:"Support with €1.99", soon:"将跳转到 Stripe 安全支付页面。", feedbackLabel:"也可以顺手写点想法", feedbackPlaceholder:"有什么希望我们改进的吗？"},
